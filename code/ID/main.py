...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        val_loss, avg_loss = train(train_loader, model, lemniscate, criterion, optimizer, epoch)
